...
def check_pattern():
    ...
    pattern = re.compile(r'^([0-9]{2,4}[\/](02[\/]([12][0-9]|0[1-9])|(0[13578]|1[02])[\/]([12][0-9]|0[1-9]|3[01])|(0[469]|11)[\/]([12][0-9]|0[1-9]|30))|[0-9]{2,4}[\-](02[\-]([12][0-9]|0[1-9])|(0[13578]|1[02])[\-]([12][0-9]|0[1-9]|3[01])|(0[469]|11)[\-]([12][0-9]|0[1-9]|30))|(([12][0-9]|0[1-9])[\/]02|([12][0-9]|0[1-9]|3[01])[\/](0[13578]|1[02])|([12][0-9]|0[1-9]|30)[\/](0[469]|11))[\/][0-9]{2,4}|(([12][0-9]|0[1-9])[\-]02|([12][0-9]|0[1-9]|3[01])[\-](0[13578]|1[02])|([12][0-9]|0[1-9]|30)[\-](0[469]|11))[\-][0-9]{2,4})$')
